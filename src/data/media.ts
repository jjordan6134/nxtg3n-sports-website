...
const marquisCarverSmithMediaItems: MediaItem[] = [
  {
    id: "marquis-carver-smith-season-highlights",
    athleteSlug: "marquis-carver-smith",
    type: "highlight",
    platform: "rumble",
    title: "Marquis Carver-Smith — 2025–26 Season Highlights",
    description: "The 6'6\" Truman State forward showcases his two-way versatility, athleticism, finishing, rebounding and floor-spacing ability.",
    mediaUrl: "https://rumble.com/shorts/v7ev112?mref=4o7brs&mc=d1eha",
    originalUrl: "https://rumble.com/shorts/v7ev112?mref=4o7brs&mc=d1eha",
    sourceName: "Rumble",
    sourceUrl: "https://rumble.com/shorts/v7ev112?mref=4o7brs&mc=d1eha",
    publisherId: "u4o7brs",
    videoId: "v7coo3k",
    playerTitle: "Marquis Carver-Smith 2025–26 season highlights",
    embedUrl: "https://rumble.com/embed/v7coo3k/?pub=u4o7brs",
    embedStatus: "embedded",
    fallbackUrl: "https://rumble.com/shorts/v7ev112?mref=4o7brs&mc=d1eha",
    actionLabel: "Watch on Rumble",
    featured: true,
    featuredPriority: 0,
    sponsorSafe: true,
  ...
  {
    id: "marquis-carver-smith-exclusive-workout",
    athleteSlug: "marquis-carver-smith",
    type: "highlight",
    platform: "rumble",
    title: "Marquis Carver-Smith — Exclusive NXTG3N Workout",
    description: "An exclusive workout look at Marquis Carver-Smith's movement, skill development, touch and athletic preparation.",
    mediaUrl: "https://rumble.com/shorts/v7ev2bq?mref=4o7brs&mc=d1eha",
    originalUrl: "https://rumble.com/shorts/v7ev2bq?mref=4o7brs&mc=d1eha",
    sourceName: "Rumble",
    sourceUrl: "https://rumble.com/shorts/v7ev2bq?mref=4o7brs&mc=d1eha",
    publisherId: "u4o7brs",
    videoId: "v7cope8",
    playerTitle: "Marquis Carver-Smith exclusive NXTG3N workout",
    embedUrl: "https://rumble.com/embed/v7cope8/?pub=u4o7brs",
    embedStatus: "embedded",
    fallbackUrl: "https://rumble.com/shorts/v7ev2bq?mref=4o7brs&mc=d1eha",
    actionLabel: "Watch on Rumble",
    featuredPriority: 1,
    sponsorSafe: true,
  },
  {
    id: "marquis-carver-smith-instagram-post",
    athleteSlug: "marquis-carver-smith",
    type: "social",
    platform: "instagram",
    title: "Marquis Carver-Smith on Instagram",
    mediaUrl: "https://www.instagram.com/p/DRFNS3SjT1A/",
    originalUrl: "https://www.instagram.com/p/DRFNS3SjT1A/",
    sourceName: "Instagram",
    sourceUrl: "https://www.instagram.com/p/DRFNS3SjT1A/",
    actionLabel: "Open Instagram post",
    socialPostType: "post",
    sponsorSafe: true,
  },
  {
    id: "marquis-carver-smith-instagram-profile",
    athleteSlug: "marquis-carver-smith",
    type: "social",
    platform: "instagram",
    title: "Follow Marquis Carver-Smith on Instagram",
    mediaUrl: "https://www.instagram.com/popular/marquis-carver-smith/",
    originalUrl: "https://www.instagram.com/popular/marquis-carver-smith/",
    sourceName: "Instagram",
    sourceUrl: "https://www.instagram.com/popular/marquis-carver-smith/",
    actionLabel: "Open Instagram",
    sponsorSafe: true,
  },
];

const langstonWilsonMediaItems: MediaItem[] = [
  {
    id: "langston-wilson-mid-season-highlights",
    athleteSlug: "langston-wilson",
    type: "highlight",
    platform: "rumble",
    title: "Langston J. Wilson — 2025–26 Mid-Season Highlights",
    description: "Explosive 6'9\" forward Langston J. Wilson showcases powerful finishing, athleticism, rim pressure, rebounding and defensive impact.",
    mediaUrl: "https://rumble.com/v7ev66e-langston-j.-wilson-202526-mid-season-highlights-explosive-69-forward.html?mref=4o7brs&mc=d1eha",
    originalUrl: "https://rumble.com/v7ev66e-langston-j.-wilson-202526-mid-season-highlights-explosive-69-forward.html?mref=4o7brs&mc=d1eha",
    sourceName: "Rumble",
    sourceUrl: "https://rumble.com/v7ev66e-langston-j.-wilson-202526-mid-season-highlights-explosive-69-forward.html?mref=4o7brs&mc=d1eha",
    publisherId: "u4o7brs",
    videoId: "v7cot8w",
    playerTitle: "Langston J. Wilson 2025–26 mid-season highlights",
    embedUrl: "https://rumble.com/embed/v7cot8w/?pub=u4o7brs",
    embedStatus: "embedded",
    fallbackUrl: "https://rumble.com/v7ev66e-langston-j.-wilson-202526-mid-season-highlights-explosive-69-forward.html?mref=4o7brs&mc=d1eha",
    actionLabel: "Watch on Rumble",
    featured: true,
    featuredPriority: 0,
    sponsorSafe: true,
  ...
  {
    id: "langston-wilson-two-hand-slam",
    athleteSlug: "langston-wilson",
    type: "highlight",
    platform: "rumble",
    title: "Langston J. Wilson — Strong Two-Hand Slam",
    description: "Langston J. Wilson rises with power and finishes a strong two-hand slam during New York NBA Summer League action.",
    mediaUrl: "https://rumble.com/shorts/v7ev6x0?mref=4o7brs&mc=d1eha",
    originalUrl: "https://rumble.com/shorts/v7ev6x0?mref=4o7brs&mc=d1eha",
    sourceName: "Rumble",
    sourceUrl: "https://rumble.com/shorts/v7ev6x0?mref=4o7brs&mc=d1eha",
    publisherId: "u4o7brs",
    videoId: "v7cotzi",
    playerTitle: "Langston J. Wilson strong two-hand slam",
    embedUrl: "https://rumble.com/embed/v7cotzi/?pub=u4o7brs",
    embedStatus: "embedded",
    fallbackUrl: "https://rumble.com/shorts/v7ev6x0?mref=4o7brs&mc=d1eha",
    actionLabel: "Watch on Rumble",
    featuredPriority: 1,
    sponsorSafe: true,
  },
  {
    id: "langston-wilson-x-profile",
    athleteSlug: "langston-wilson",
    type: "social",
    platform: "x",
    title: "Follow Langston J. Wilson on X",
    mediaUrl: "https://x.com/Langston3491",
    originalUrl: "https://x.com/Langston3491",
    sourceName: "X @Langston3491",
    sourceUrl: "https://x.com/Langston3491",
    actionLabel: "Open X",
    sponsorSafe: true,
  },
  {
    id: "langston-wilson-instagram-profile",
    athleteSlug: "langston-wilson",
    type: "social",
    platform: "instagram",
    title: "Follow Langston J. Wilson on Instagram",
    mediaUrl: "https://www.instagram.com/langstonjwilson/",
    originalUrl: "https://www.instagram.com/langstonjwilson/",
    sourceName: "Instagram @langstonjwilson",
    sourceUrl: "https://www.instagram.com/langstonjwilson/",
    actionLabel: "Open Instagram",
    sponsorSafe: true,
  },
];

export const mediaItems: MediaItem[] = [...athletePhotoItems, ...articleMediaItems, ...danielWondieMediaItems, ...vynceOvershownMediaItems, ...demarcusBarrMediaItems, ...darrionBrooksMediaItems, ...calebColemanMediaItems, ...marquisCarverSmithMediaItems, ...langstonWilsonMediaItems];
