...
export default function ResourcesPage() {
  return <main>
    ...
    <section className="mx-auto max-w-7xl space-y-8 px-4 pb-16 sm:px-6 lg:px-8"><NilReadinessAssessment /><DealReviewChecklist /></section>
