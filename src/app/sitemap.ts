...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = ["", "/news", "/resources", "/resources/athlete-brand-blueprint", "/resources/campaign-budget-planner", "/talent", "/services", "/partners", "/media", "/about", "/apply", "/contact", "/privacy", "/terms", "/editorial-standards"];
