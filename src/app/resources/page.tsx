...
export default function ResourcesPage() {
  return <main>
    ...
    <section className="mx-auto max-w-7xl space-y-8 px-4 pb-16 sm:px-6 lg:px-8"><div className="grid gap-5 lg:grid-cols-2"><div className="rounded-[2rem] border border-[#2AFF7D]/30 bg-gradient-to-br from-[#13233E] to-[#101722] p-6 sm:p-8"><p className="text-xs font-black uppercase tracking-[0.22em] text-[#2AFF7D]">Athlete tool</p><h2 className="mt-3 text-3xl font-black text-white">Athlete Brand Blueprint</h2><p className="mt-3 text-sm leading-6 text-[#C7CCD6]">Turn an athlete’s markets, values, content strengths, and partner fit into a downloadable 30-day preparation plan.</p><Link href="/resources/athlete-brand-blueprint" className="mt-6 inline-flex rounded-full bg-[#2AFF7D] px-5 py-3 text-sm font-black text-[#07120B] hover:bg-white">Build the blueprint</Link></div><div className="rounded-[2rem] border border-[#1F6AE1]/50 bg-gradient-to-br from-[#142B50] to-[#101722] p-6 sm:p-8"><p className="text-xs font-black uppercase tracking-[0.22em] text-[#2AFF7D]">Business tool</p><h2 className="mt-3 text-3xl font-black text-white">Campaign Budget Planner</h2><p className="mt-3 text-sm leading-6 text-[#C7CCD6]">Allocate a real working budget, select deliverables and usage, and download a sponsor-ready planning brief.</p><Link href="/resources/campaign-budget-planner" className="mt-6 inline-flex rounded-full bg-[#1F6AE1] px-5 py-3 text-sm font-black text-white hover:bg-[#2E7BFF]">Plan a campaign</Link></div></div><NilReadinessAssessment /><DealReviewChecklist /></section>
